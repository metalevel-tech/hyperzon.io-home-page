...
import { galleryHandler_Images, galleryHandler_PostPageImgs, galleryHandler_Videos } from "./module_gallery.js";
...
const bodyClasses = []; // Add class .sticky {position:fixed} to the main menu when the page is scrolled.
...
function interfaceSetUp(callFrom = 0) {
  ...
  blogInit();
  bookACallHandler();
  addSpaFuncToPageContent(); // console.log(callFrom);
      ...
      case 14:
        ...
        window.onpopstate = function (e) {
          if (e.state) {
            ...
            document.body.className = e.state.bodyClassList; // Evaluate the page content restored from the history
...
window.addEventListener("load", function () {
  // Set the main menu functionality
  addSpaFuncToTheMenus(); // Handle the case when URI is "/" or "index.php"
  ...
  setTimeout(function () {
    ...
    if (bodyClasses.indexOf("index.php") > -1 || bodyClasses.indexOf("home") > -1) {
      ...
      document.body.classList.replace("index.php", "home"); // Set the "home" menu item to the active state

      document.querySelector(".main-menu__logo a.spa-menu-item").classList.add("selected-item"); // Change the URI
