...
$(document).on("ready", function () {
    ...
    $('a.image').on("click", function (e) {
        ...
        $('#lightbox')
            .html('<img src="' + src + '" style="padding:14px;background:#fdfdfd;border: 1px solid #ccc;border-bottom-width: 5px;box-shadow: 0 0 30px #222;max-height:70%;max-width:70%;margin-left:170px;margin-bottom:20px;vertical-align:bottom;cursor:pointer;" />')
