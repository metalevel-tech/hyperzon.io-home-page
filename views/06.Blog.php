            ...
            <div id="blog-section">
                <div class="blog-tags-container">
                    ...
                    <div class="blog-tags-list">
                        <a role="button" class="blog-tag">All</a>
                        <a role="button" class="blog-tag">Marketing news</a>
                        <a role="button" class="blog-tag">Success stories</a>
                        <a role="button" class="blog-tag">Package design</a>
                        <a role="button" class="blog-tag">Amazon news</a>
                        <a role="button" class="blog-tag">Video content</a>
                        <a role="button" class="blog-tag">Photo content</a>
                        <a role="button" class="blog-tag">Branding</a>
                        <a role="button" class="blog-tag">Events</a>
                    </div>
                </div>
